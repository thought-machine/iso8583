...
func TestCompositePackingWithID(t *testing.T) {
	...
	t.Run("Pack correctly serialises fully populated data to bytes", func(t *testing.T) {
		data := &CompsiteTestData{
			F1: NewStringValue("AB"),
			F2: NewStringValue("CD"),
			F3: NewNumericValue(12),
	...
	t.Run("Pack correctly serialises partially populated data to bytes", func(t *testing.T) {
		data := &CompsiteTestData{
			F1: NewStringValue("AB"),
			F3: NewNumericValue(12),
		}
